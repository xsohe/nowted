  ...
  return (
    <div className="flex relative justify-between sm:max-lg">
      ...
      <form onSubmit={handleSubmit}>
        <input type="text" placeholder="Write note" className="border border-b-gray-400 px-3 py-1 m-2 border-transparent outline-none" autoFocus value={name} onChange={(e) => setName(e.target.value)} />
